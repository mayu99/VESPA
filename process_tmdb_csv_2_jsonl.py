...
Original file is located at
    https://colab.research.google.com/drive/1iWu5x8CH5WWKlcU-bzsp8toRZfjQensx
"""
...
def combine_features(row):
  try:
    return row['overview']+" "+row["genres"]
  except:
    print ("Error:", row)
...
def process_tmdb_csv(input_file, output_file):
  ...
  # print(movies.head())
  for f in ['original_title','overview','genres']:
...
process_tmdb_csv("imdb.csv", "clean_tmdb_new.jsonl")
